    ...
    <section className="relative w-full h-[85vh] md:h-screen overflow-hidden group">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6 z-10 max-w-5xl mx-auto">
        <div className="overflow-hidden mb-6">
          <span className="inline-block text-[#E6C77A] border-b  border-[#ffe59d] text-sm md:text-base font-medium tracking-[0.3em] uppercase pb-2">
        ...
        <p className="text-gray-200 text-lg md:text-2xl mb-12 max-w-2xl font-light leading-relaxed font-[family-name:var(--font-geist-sans)] tracking-wide">
          Handcrafted masterpieces designed to make your special day truly
          unforgettable.
        </p>
        ...
        >
          <span className="uppercase tracking-[0.2em] text-[#E6C77A] text-sm font-semibold transition-colors duration-300 group-hover/btn:text-black">
